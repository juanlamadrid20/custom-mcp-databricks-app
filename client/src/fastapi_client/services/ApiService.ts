...
export class ApiService {
   ...
   * @throws ApiError
   */
  public static listPromptsApiPromptsGet(): CancelablePromise<
   ...
   * @throws ApiError
   */
  public static getMcpInfoApiMcpInfoInfoGet(): CancelablePromise<
    Record<string, any>
  > {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static getMcpDiscoveryApiMcpInfoDiscoveryGet(): CancelablePromise<
    Record<string, any>
  > {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static getMcpConfigApiMcpInfoConfigGet(): CancelablePromise<
    Record<string, any>
  > {
    return __request(OpenAPI, {
      method: "GET",
